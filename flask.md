...
Bootstrap — это CSS-фреймворк, который предоставляет несколько готовых классов CSS и простой способ стилизации вашего веб-сайта.

Для того, чтобы сделать такой шаблон:
```
<!doctype html>
<html>
<head>
